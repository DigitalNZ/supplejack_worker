...
describe LinkCheckRulesController do
  ...
  describe "POST 'create'" do
    it 'should make a new collection rule and assign it' do
      LinkCheckRule.should_receive(:create).with('collection_title' => 'collection_title', 'status_codes' => '203,205') { link_check_rule }
      post :create, link_check_rule: { collection_title: 'collection_title', status_codes: '203,205' }
  ...
  describe "PUT 'update'" do
    it "should find the link_check_rule" do
      LinkCheckRule.should_receive(:find) { link_check_rule }
      put :update, id: link_check_rule.id, link_check_rule: { collection_title: 'collection_title', status_codes: '203,205' }
      assigns(:link_check_rule) { link_check_rule }
    end
